    ...
    return (
        <div className="flex flex-col md:m-auto w-full md:w-1/2 border-2" >
            ...
            <div className="flex m-auto justify-center p-3">
                <button name="advertBtnSave" className="inline-flex items-center rounded-md border mr-10 border-gray-300 bg-indigo-800 px-4 py-3 text-sm font-medium text-gray-300 shadow-sm hover:bg-indigo-700 hover:shadow-md focus:ring-2 focus:ring-indigo-500">Publicar</button>
