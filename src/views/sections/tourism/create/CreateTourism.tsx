...
const CreateTourism = () => {
    ...
    return(
        ...
        <div className="h-20 w-full flex  bg-blue-900 rounded-t-md ">
            ...
            <div>
                    <button name="tourismBtnSave" className="bg-indigo-600 p-3 m-5 rounded-md focus:ring-2 ring-blue-800 hover:bg-indigo-700 text-white">Publicar</button>
                    <button name="tourismBtnCancel" className="bg-indigo-600 p-3 rounded-md focus:ring-2 ring-blue-800 hover:bg-indigo-700 text-white" onClick={() => navigate(-1)}>Cancelar</button>
            </div>
        </div>
    )
}
