...
const Event = () => {
  ...
  useEffect(() => {
    eventStore.getRequestEvents('Bolea', 0, 1)
  }, [])
  ...
  return (
    <div className="w-full h-full  relative">
      <div className=" flex flex-col gap-4">
        ...
        <TableEvent  headerList={['Título', 'Descripción', 'Precio de Reserva', 'Plazas', 'Capacidad', 'Localidad', 'Dirección', 'Organización', 'Acciones']} />
      </div>
      <div className="flex absolute left-0 bottom-0 right-0  items-center justify-center md:flex-row flex-col">
        ...
        <button disabled={eventStore.getPaginatedEvents.content?.length!! < 10} className="inline-flex items-center rounded-md border  disabled:bg-gray-500 border-gray-300 bg-indigo-800 px-4 py-3 text-sm font-medium text-gray-300 shadow-sm hover:bg-indigo-700 hover:shadow-md focus:ring-2 focus:ring-indigo-500">
          Siguiente
