...
const Service = () => {
  ...
  useEffect(() => {
    serviceStore.getPaginatedServiceRequest(localStorage.getItem('user_etno_locality')!, searchFilter, pageNumber, 5)
  }, [pageNumber])
  ...
  function deleteByGroup(){
    if(serviceStore.getServicesCheckedList.length > 0){
      serviceStore.deleteAllById(localStorage.getItem('user_etno_locality')!)
    }
  }
  return (
