...
const Necrologue = () => {
  ...
  useEffect(() => {
    necrologueStore.getPaginatedNecroRequest(localStorage.getItem('user_etno_locality')!, searchFilter, pageNumber, 5)
  }, [pageNumber])
  ...
  function deleteByGroup() {
    if (necrologueStore.getDeathsCheckedList.length > 0) {
      necrologueStore.deleteAllById(localStorage.getItem('user_etno_locality')!)
    }
  }
  return (
