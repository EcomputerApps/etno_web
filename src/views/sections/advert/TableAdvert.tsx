...
const TableAdvert = (prop: PropTable) => {
    ...
    function deleteConfirmation(ad: Ad) {
        setConfirm(true)
        setDelTitle(ad.title!!)
        setDelId(ad.idAd!!)
    }
                            ...
                            <tr key={index} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 text-center">
                                 <td className="tableCamp">
                                    ...
                                    <input type="checkbox" onChange={(value) => {
                                        if (value.currentTarget.checked) {
                                         advertStore.adsListChecked.push(advert);
                                        } else {
                                          advertStore.adsListChecked.splice(advertStore.getAdsCheckedList.indexOf(advert), 1)
                                        }
                                ...
                                <td className="tableCamp">
                                    <div className="h-20 flex items-center justify-center">
                                        ...
                                        <a href="#" className="font-medium text-red-600 dark:text-red-500 hover:underline m-2" onClick={() => deleteConfirmation(advert)}>Eliminar</a>
                                    </div>
                                </td>
                            </tr>
                        ))}
                                ...
                                <div className=" flex justify-center mt-10 ">
                                    <div className="flex flex-col bg-white lg:w-1/4 w-1/2 h-1/2 rounded-md border-2">
                                        ...
                                        <div className="flex justify-center m-auto mt-5 mb-3">
                                            <button className="btnStandard w-14 h-10 mr-5 " onClick={() => deleteAdvert(delId)}>SI</button>
