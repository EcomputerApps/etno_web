...
const Incident = () => {
  ...
  useEffect(() => {
    incidentStore.getPaginatedIncidentsRequest(localStorage.getItem('user_etno_locality')!, searchFilter, pageNumber, 6)
  }, [pageNumber])
