...
const Sponsor = () => {
  ...
  useEffect(() => {
    sponsorStore.getPaginatedSponsorRequest(localStorage.getItem('user_etno_locality')!, searchFilter, pageNumber, 5)
  }, [pageNumber])
