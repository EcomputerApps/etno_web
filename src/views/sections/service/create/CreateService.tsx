    ...
    return (
        <div className="flex flex-col md:m-auto w-full md:w-1/2 border-2 rounded-md" >
           ...
           border-2 rounded-md  peer focus:outline-none focus:border-indigo-800"  onChange={(e) => {
                        ...
                        <div className="p-3 flex flex-row" >
                            <div className="relative p-2">
                                <input ref={inputScheMorn} placeholder=" " hidden={serviceShcedulSelector === "L-V.Compl" || serviceShcedulSelector === "L-S.Compl" || serviceShcedulSelector === "L-D.Compl"} name="pharmacyShedulesMorning" type="text" className="border-2 rounded-md p-1 mr-2 autofill:shadow-[inset_0_0_0px_30px_rgb(255,255,255)]
           peer focus:outline-none focus:border-indigo-800" onKeyDown={(e) => {
                                ...
                                <label hidden={serviceShcedulSelector === "L-V.Compl" || serviceShcedulSelector === "L-S.Compl" || serviceShcedulSelector === "L-D.Compl"} className={"float-input-lbl"}>Mañana</label>
                            </div>
                            <div className="relative p-2">
                                <input ref={inputScheEven} placeholder=" " hidden={serviceShcedulSelector === "L-V.Compl" || serviceShcedulSelector === "L-S.Compl" || serviceShcedulSelector === "L-D.Compl"} name="pharmacyShedulesEvening" type="text" className="border-2 rounded-md p-1 mr-2 autofill:shadow-[inset_0_0_0px_30px_rgb(255,255,255)]
           peer focus:outline-none focus:border-indigo-800" onKeyDown={(e) => {
                                        if ((e.code === "Enter") || (e.code === "NumpadEnter")) {
                                            if (inputScheExtra.current != null) {
                                                inputScheExtra.current.focus()
                                ...
                                <label hidden={serviceShcedulSelector === "L-V.Compl" || serviceShcedulSelector === "L-S.Compl" || serviceShcedulSelector === "L-D.Compl"} className={"float-input-lbl"}>Tarde</label>
                            </div>
                            <div className="relative p-2">
                                <input ref={inputScheExtra} placeholder=" " hidden={serviceShcedulSelector === "L-V.Part" || serviceShcedulSelector === "L-S.Part" || serviceShcedulSelector === "L-D.Part"} name="pharmacyShedulesExtra" type="text" className="border-2 rounded-md p-1 mr-2 autofill:shadow-[inset_0_0_0px_30px_rgb(255,255,255)]
           peer focus:outline-none focus:border-indigo-800" onKeyDown={(e) => {
                                        if ((e.code === "Enter") || (e.code === "NumpadEnter")) {
                                            if (txtAreaRef.current != null) {
                                                txtAreaRef.current.focus()
                                ...
                                <label hidden={serviceShcedulSelector === "L-V.Part" || serviceShcedulSelector === "L-S.Part" || serviceShcedulSelector === "L-D.Part"} className={"float-input-lbl"}>Completa</label>
                            </div>
                        </div>
                    </div>
                </div>
