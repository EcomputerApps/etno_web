...
const EditPharmacy = () => {
    ...
    const [pharmacyDescption, setPharmacyDescption] = useState<string>(pharmacy.description!!)
...
setPharmStartDate(e.currentTarget.valueAsDate!)
        ...
        <div className="w-full flex flex-1 flex-col mt-5 pl-3">
            <div className="flex flex-col p-1 relative">
                <input defaultValue={pharmacyName} autoFocus ref={inputTitle} placeholder=" " name="pharmacyName" type="text" className="inputCamp peer" onChange={(e) => {
        ...
        <div className="w-full flex flex-1 flex-col pl-3 mt-3">
            <div className="flex flex-col p-1 relative  ">
                <input defaultValue={pharmacyWebUrl} ref={inputWebUrl} placeholder=" " name="pharmacyUrl" className="inputCamp peer" onChange={(e) => {
        ...
        <div className="w-full flex flex-1 flex-col mt-3 pl-3">
            <div className="flex flex-col p-1 relative">
                <textarea defaultValue={pharmacyDescption} ref={txtAreaRef} placeholder=" " name="pharmacyDescription" maxLength={495} rows={3} className="inputCamp peer" onKeyDown={(e) => {
                    if ((e.code === "NumpadEnter")) {
