         ...
         return(
            ...
            <div className="w-full flex flex-1 flex-col pl-3">
                <div className="flex flex-col p-1">
                    ...
                    <input type="date" name="newsDate" className="w-40 border-2 rounded-sm"/>
                </div>
            </div>
            <div className="w-full flex flex-1 flex-col pl-3">
                <div className="flex flex-col p-1">
                    <label className="text-left text-2xl p-1">Descripción</label>
                    <textarea placeholder="Descripcion" name="newsDescription"  rows={3}  className="border-2 rounded-md p-2"></textarea>
                </div>
            </div>
            <div className="w-full flex flex-1 flex-col pl-3">
                <div className="flex flex-col p-1">
                    <label className="text-left text-2xl p-1">Enlace</label>
                    <input placeholder="www.ecomputer.es" name="newsUrl" type="text"  className="border-2 rounded-md p-2"></input>
                </div>
            </div>
            <div className="w-full flex flex-1 flex-col pl-3">
                <div className="flex flex-col p-1">
