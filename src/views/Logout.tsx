    ...
    <div className="flex h-screen items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="flex md:flex-row m-auto justify-center w-3/4 p-3">
          <button name="bandBtnSave" className="inline-flex justify-center w-full items-center rounded-md border mr-5  border-gray-300 bg-indigo-800 px-6 py-3 text-sm font-medium text-gray-300 shadow-sm  hover:bg-indigo-700 hover:shadow-md focus:ring-2 focus:ring-indigo-500" onClick={() => navigate("/")}>Si</button>
