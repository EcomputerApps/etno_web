...
const CreateNecrologue = () =>{
    ...
    const{
        acceptedFiles, getRootProps, getInputProps, isDragActive} = useDropzone(
        ...
        <div className="h-20 w-full flex  bg-blue-900 rounded-t-md ">
            ...
            <div className="w-full flex flex-1 flex-col pl-3">
                <div className="flex flex-col p-1">
                    ...
                    <input placeholder="Nombre" name="necroName" type="text"  className="border-2 rounded-md p-2"></input>
                </div>
            </div>
            <div className="w-full flex flex-1 flex-col pl-3">
                <div className="flex flex-col p-1">
                   <label className="text-left text-2xl p-1">Fecha de fallecimiento</label>
                   <input type="date" name="necroDate" className="w-40 border-2 rounded-md"/>
                </div>
            </div>
            <div className="w-full flex flex-1 flex-col pl-3">
                <div className="flex flex-col  p-1">
