    ...
    <div className="flex flex-col md:m-auto w-full md:w-1/2 border-2 rounded-md" >
      ...
      <div className="w-full flex flex-1 flex-col pl-3">
        <div className="flex flex-col p-1">
          ...
          <input autoFocus placeholder="Nombre" name="necroName" type="text" className="border-2 rounded-md p-2" onChange={(value) => {
      ...
      <div className="w-full flex flex-1 flex-col pl-3">
        <div className="flex flex-col p-1">
          <label className="text-left text-2xl p-1">Fecha de fallecimiento</label>
          <input ref={inputRef} type="date" name="necroDate" className="w-40 border-2 rounded-md" onChange={(value) => {
      ...
      <div className="w-full flex flex-1 flex-col pl-3">
        <div className="flex flex-col  p-1">
          ...
          <textarea ref={txtAreaRef} placeholder="Description" name="eventDescription" rows={3} className="border-2 rounded-md p-2" onChange={(value) => {
